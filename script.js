...
function initQuiz() {
    ...
    let questions = [
        ...
        {
            question: "Какое второе имя Конора?",
            options: ["Тоня", "Поня", "Шмонор", "Одно имя"],
            correct: "Шмонор"
        },
        {
            question: "Какой твой самый любимый салат?",
            options: ["Королевский", "Мимоза", "Крабовый", "Зимний"],
            correct: "Зимний"
        },
        {
        ...
        {
            question: "На сколько раньше ты приезжаешь на работу?",
            options: ["Я опаздываю", "За 10 минут", "За час", "Какая работа?"],
            correct: "За час"
        }
    ];
